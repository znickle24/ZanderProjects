window.onload=function() {
	...
	mySocket.onmessage=function (event) {
		...
		let mText=messObject.user+ " sent: "+ messObject.message;
		...
		if (username !== messObject.user) {
			messageP.style.left = '10px'; 
		} else {
			messageP.style.left = '250px';
		}
		...
		// let bubbles = document.getElementById("message"); 
}
